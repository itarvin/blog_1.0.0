...
<div class="x-body">
    <form class="layui-form">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" name="url" required="" value="http://192.168.0.2/public/musiclist/" autocomplete="off" class="layui-input">
            </div>
        </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" name="author" value="itarvin" autocomplete="off" class="layui-input">
            </div>
        </div>
...
layui.use(['form','layer','upload'], function(){
    ...
    form.on('submit(add)', function(data){
        //发异步，把数据提交给php
        $.post("{{url('admin/music')}}",data.field,function(res){
